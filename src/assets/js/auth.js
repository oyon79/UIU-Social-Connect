...
function validateEmail() {
    ...
    if (!uiuEmailRegex.test(email)) {
        emailInput.classList.add('is-invalid');
        emailError.textContent = 'Email must be in UIU format: username@domain.uiu.ac.bd';
        return false;
    }
...
async function handleForgotPassword(e) {
    ...
    if (!uiuEmailRegex.test(resetEmail)) {
        resetEmailInput.classList.add('is-invalid');
        resetEmailError.textContent = 'Email must be in UIU format: username@domain.uiu.ac.bd';
        return;
    }
